...
class _ExtractMeasurements(structure.Component):
...
class _ExtractMetadata(structure.Component):
...
class _Merge(structure.Component):
...
class Extract(structure.Composite):
