...
from utils.paths import CONFIG_DIRECTORY, ICOS_CITIES_LEVEL_2, LOG_DIRECTORY

assert (os.path.exists(ICOS_CITIES_LEVEL_2))
...
# load csv files
L2_filenames = glob.glob(os.path.join(ICOS_CITIES_LEVEL_2, '*.csv'))
