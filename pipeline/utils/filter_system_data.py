...
df_gas = pl.read_csv(AVERAGED_GASES).with_columns(
    pl.col("cal_bottle_id").cast(pl.Float32),
    pl.col("cal_bottle_CO2").cast(pl.Float64))
...
def extract_edge_calibration_data(df_raw: pl.LazyFrame) -> pl.DataFrame:
